...
# # New IP access list entry for GCP auto-mode network CIDR
...
#   project_id       = mongodbatlas_project.project.id
#   atlas_cidr_block = var.atlas_cidr_block // This must be a unique CIDR block and not overlap with other network resources
#   provider_name    = "GCP"
